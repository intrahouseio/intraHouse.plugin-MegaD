        ...
        if (onearr.length == 2) {
          ...
          if (str.substr(0, 2) == "OF" || str.substr(0, 2) == "ON") {
            ...
            if (xarr.length == 1) {
              ...
              res =
                res + adrx + "_" + onearr[0] + "=" + getOnOffValue(xarr[0]) + "&";
            } else {
                res =
                res + adrx + "_" + onearr[0] + "_A=" + getOnOffValue(xarr[0]) + "&";
                res =
                res + adrx + "_" + onearr[0] + "_B=" + getOnOffValue(xarr[1]) + "&";
            }
          } else {
